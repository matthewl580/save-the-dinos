...
const CausePage = () => {
  return (
    <div className="relative flex flex-col items-center justify-start min-h-screen bg-background font-pixelated p-8">
      ...
      <p className="text-lg text-center mb-8 text-teal-500">
      ...
      <div className="w-full h-64 relative mb-4 rotate-element">
      ...
      <p className="text-lg text-center mb-8 text-purple-300">
      ...
      <p className="text-lg text-center mb-8 text-orange-400">
      ...
      <p className="text-lg text-center mb-8 text-pink-300">
      ...
      <p className="text-lg text-center mb-8 text-lime-300">
      ...
      <p className="text-lg text-center mb-8 text-fuchsia-300">
      ...
      <p className="text-lg text-center mb-8 text-rose-300">
      ...
      <p className="text-lg text-center mb-8 text-amber-300">
      ...
      <p className="text-lg text-center mb-8 text-emerald-300">
      ...
      <p className="text-lg text-center mb-8 text-violet-300">
      ...
      <p className="text-lg text-center mb-8 text-teal-300">
      ...
      <p className="text-lg text-center mb-8 text-sky-300">
      ...
      <p className="text-lg text-center mb-8 text-indigo-300">
      ...
      <p className="text-lg text-center mb-8 text-stone-300">
      ...
      <ul className="list-disc list-inside text-lg mb-8 text-green-300">
